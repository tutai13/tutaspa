  ...
  <div class="layout">
    ...
    <header class="top-nav">
      ...
      <div class="nav-right" v-if="authStore.isAuthenticated"> 
        ...
        <div class="dropdown">
          <button class="btn btn-light dropdown-toggle" id="dropdownUser" data-bs-toggle="dropdown">
            <img src="/src/assets/img/user-1.jpg" alt="User" class="avatar-img" />
          </button>
          <ul class="dropdown-menu dropdown-menu-end mt-2 shadow rounded-3 p-3" aria-labelledby="dropdownUser">
            <li>
              <a class="dropdown-item d-flex align-items-center gap-2 text-secondary" href="/profile">
                <i class="fas fa-user fs-6"></i> Thông tin tài khoản
              </a>
            </li>
            <li>
              <a class="dropdown-item d-flex align-items-center gap-2 text-secondary" href="#">
                <i class="fas fa-envelope fs-6"></i> Đổi mật khẩu
              </a>
            </li>
            <li>
              <a class="dropdown-item d-flex align-items-center gap-2 text-secondary" href="/ve-da-dat">
    ...
    <aside class="sidebar" v-if="authStore.isAuthenticated">
      <div class="menu">
        ...
        <template v-if="authStore.isAdmin">
          ...
          <router-link to="/khuyenMai" class="menu-item" exact-active-class="active" title="Quản lý Khuyến mãi">
            <i class="fas fa-shopping-cart"></i>
          </router-link>
          <router-link to="/QuanLySanPham" class="menu-item" exact-active-class="active" title="Quản lý Sản phẩm">
            <i class="fas fa-box"></i>
          </router-link>
          <router-link to="/employees" class="menu-item" exact-active-class="active" title="Quản lý nhân viên">
            <i class="fas fa-user-friends"></i>
          </router-link>
          <router-link to="/DanhGiaKhachHang" class="menu-item" exact-active-class="active" title="Quản lý Đánh Giá">
            <i class="fas fa-star"></i>
          </router-link>
        </template>

        <!-- Menu cho InventoryManagement -->
        <template v-if="authStore.isInventoryManager">
          <router-link to="/kho" class="menu-item" exact-active-class="active" title="Quản lý kho">
        ...
        <template v-if="authStore.isCashier">
          <router-link to="/ThuNgan" class="menu-item" exact-active-class="active" title="Thu Ngân">
            <i class="fa-solid fa-wallet"></i>
          </router-link>
          <router-link to="/chat" class="menu-item" exact-active-class="active" title="Chat">
            <i class="fa-solid fa-comment"></i>
          </router-link>
        </template>
        <div class="menu-title">APPS</div>
        <!-- Thống kê - Hiển thị cho Admin và Manager -->
        <router-link 
        ...
        <router-link to="/apps/profile" class="menu-item" exact-active-class="active" title="User Profile">
